...
{
	/// <summary>
	/// The component to spawn a prefab on GameObject destroy
	/// </summary>
	class SpawnOnDestroyComponent : public BaseComponent
	{
	public:
		...
		SpawnOnDestroyComponent(BalisongEngineOCM::GameObject* go, const std::string& comp_name = "[SpawnOnDestroyComponent]");
		...
		/// <summary>
		/// The prefab name to look for and spawn
		/// </summary>
		std::string prefabName = "EnemyExplode";
